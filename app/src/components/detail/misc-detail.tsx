...
const SKILL_KNOWN = new Set(['descLong', 'levelRestriction', 'target', 'cooldown', 'castTime', 'autoLearns']);
...
interface HarvestDetail { skillName?: string; skillLevel?: number; items?: Ref[]; maps?: Ref[]; [key: string]: unknown }
const HARVEST_KNOWN = new Set(['skillName', 'skillLevel', 'items', 'maps']);
